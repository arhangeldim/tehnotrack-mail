...
Практика оценивается из 15 баллов (если сдана до 20-00 10.11, если сдана до 17го - из 10 баллов. Иначе - 0)
...
На 10 баллов
Реализовано все, что указано выше.
Реализована работа с базой
Реализована бизнес логика UserStore/MessageStore, данные сохраняются/читаются из базы. 
Реализованы все команды из раздела выше

На 20 баллов
Для запросов в базу используются PreparedStatements
При работе с сетью используется неблокирующий ввод вывод
